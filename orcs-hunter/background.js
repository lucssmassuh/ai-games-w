...
var Background = cc.LayerColor.extend({
    ...
    backgroundMap: [
        [9, 9, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16],
        ...
        [16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16],
        [16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16],
        [1, 2, 2, 2, 2, 3, 1, 2, 2, 3, 3, 1, 2, 2, 2, 2, 2, 3, 1, 2, 2, 2, 3, 3, 1, 2, 2, 2, 2, 2, 3, 1, 2, 2, 2, 2, 2, 2, 2, 3],
    ...
    createTiledBackground: function(texture) {
        ...
        var offsetX = (cc.winSize.width - (gridWidth * tileSize)) / 2;
        var offsetY = (cc.winSize.height - (gridHeight * tileSize)) / 2;
        ...
        this.setPosition(
            (cc.winSize.width - (gridWidth * tileSize)) / 2,
            (cc.winSize.height - (gridHeight * tileSize)) / 2
        );
